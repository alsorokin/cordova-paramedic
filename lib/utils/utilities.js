...
function getWindowsPhoneAppId(appPath) {
    ...
    if (fs.existsSync(packageJSPath)) {
        ...
        return packageJS.getAppId(platformPath);
    }
    throw new Error('Couldn\'t get Windows Phone app ID');
}
...
module.exports = {
    ...
    getWindowsPhoneAppId: getWindowsPhoneAppId,
};
